<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item>
        <el-select
          v-model="searchProjectVo.status"
          placeholder="请选择订单状态"
    ...
    >
      <el-form ref="project" :model="project" label-width="100px">
        ...
        <el-form-item label="开始时间">
          <el-input v-model="project.startTime" readonly></el-input>
        </el-form-item>
        <el-form-item label="结束时间">
          <el-input v-model="project.endTime" readonly></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    viewOrderInfo(project) {
      projectApi.getProjectByProjectId(project.id).then((res) => {
        ...
        if(this.project.startTime!=null){

          this.project.startTime = this.project.startTime.replace("T", " ");
        }
        if(this.project.endTime!=null){
